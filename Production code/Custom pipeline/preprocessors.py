...
class Pipeline:
    ...
    def __init__(self, target, categorical_to_impute, year_variable,
        ...
        # dictionaries for storing intermediate variables for future use
        self.imputing_dict = {}
    ...
    # Auxilliary function required only when you want to get predictions of some data seperately.
